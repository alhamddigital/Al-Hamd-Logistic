            ...
            <div id='contact' ref={contactRef} className='bg-gray-200 contactSection'>
                <section className="">
                    <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                        ...
                        <p className="mb-8 lg:mb-16 font-light text-center text-white dark:text-gray-400 sm:text-xl">Have a question or need support? We're here to help. Reach out to us with any quotes, feedback, or concerns and we'll get back to you as soon as possible!</p>
