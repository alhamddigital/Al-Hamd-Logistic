...
const Navbar2 = () => {
  ...
  return (
    <>
      <div
        className={`w-full h-[60px] bg-white md:bg-[rgb(31,66,93)] z-20 flex justify-between items-center pr-3 md:px-[40px] lg:px-[70px] sticky top-0 md:top-[80px] lg:top-[80px] left-0`}
      >
